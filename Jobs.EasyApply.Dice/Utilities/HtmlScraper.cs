...
namespace Jobs.EasyApply.Dice.Utilities
{
    public class HtmlScraper(IWebDriver driver)
    {
        private readonly IWebDriver _driver = driver;

        // Apply button finder for Dice
        public IWebElement? FindApplyButton(string jobId)
        {
            try
            {
                ...
                // Try multiple selectors for Dice apply buttons
                var selectors = new[]
                {
        ...
        public bool HasEasyApplyIndicator(IWebElement jobCard)
        {
            try
            {
                ...
                // Check for specific Dice.com Easy Apply patterns
